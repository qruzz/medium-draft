...
var MediumDraftEditor = function (_React$Component) {
  ...
  function MediumDraftEditor(props) {
    ...
    _this.renderLimits = function () {
      if (_this.props.limit) {
        var limit = _this.props.limit;
        return _react2.default.createElement(
          'div',
          { className: 'md-limits-container' },
          _react2.default.createElement(
            'span',
            { className: limit.actual <= limit.max ? '' : 'exceeded' },
            limit.actual
          ),
          '\xA0of\xA0',
          _react2.default.createElement(
...
MediumDraftEditor.propTypes = {
  ...
  limit: _propTypes2.default.shape({
    actual: _propTypes2.default.number,
